        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Use of Services</h2>
            </div>
            
            <h3 className="text-xl font-medium mt-6 mb-3 text-gray-800">Account Registration</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-medium mt-6 mb-3 text-gray-800">User Responsibilities</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-medium mt-6 mb-3 text-gray-800">Acceptable Use</h3>
            <p className="text-gray-700 mb-4">
              You agree not to:
            </p>
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              <FileText size={24} className="text-orange-500 mr-3" />
              <h2 className="text-2xl font-semibold text-gray-800">Products and Services</h2>
            </div>
            
            <h3 className="text-xl font-medium mt-6 mb-3 text-gray-800">Courses and Digital Products</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-medium mt-6 mb-3 text-gray-800">Consulting Services</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-semibold mb-4 text-gray-800">Payment and Refunds</h2>
              <p className="text-gray-700 mb-4">
                Payment terms:
              </p>
