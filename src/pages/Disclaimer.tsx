        ...
        <div className="container px-4 md:px-6">
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">General Disclaimer</h2>
            </div>
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Professional Disclaimer</h2>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Testimonials and Case Studies</h2>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              <FileText size={24} className="text-orange-500 mr-3" />
              <h2 className="text-2xl font-semibold text-gray-800">Financial Disclaimer</h2>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              <AlertTriangle size={24} className="text-orange-500 mr-3" />
              <h2 className="text-2xl font-semibold text-gray-800">External Links Disclaimer</h2>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div className="glass-card p-6 md:p-8 mb-8">
            <div className="flex items-center mb-4">
              <FileText size={24} className="text-orange-500 mr-3" />
              <h2 className="text-2xl font-semibold text-gray-800">Payment Processing Disclaimer</h2>
            </div>
            <p className="text-gray-700 mb-4">
